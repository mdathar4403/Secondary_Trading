    ...
    return (
        <div className='container md:mt-5'>
            <div className='flex flex-col items-center'>
                ...
                <div className="mt-1 text-xl font-semibold uppercase text-grren-500">
                    Congratulations!
                </div>
                <div className="text-lg font-semibold m-2 text-gray-500">
            ...
            <hr class="flex-grow border-t m-5 border-gray-500"/>
            <div>
                <ShareModel />
            </div>
        </div>
