                ...
                <div class="fixed flex flex-col top-0 left-0 w-64 bg-gray-900 h-full shadow-lg">
                    ...
                    <div class="overflow-y-auto overflow-x-hidden flex-grow">
                        <ul class="flex flex-col py-6 space-y-1">
                            ...
                            <li>
                                <Link to="/dashboard" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-200 hover:text-gray-200 border-l-4 border-transparent hover:border-blue-500 pr-6">
